...
public class ExceptionUtils {
	...
	public static JsonExceptionResponse buildJsonErrorResponse(Exception e, HttpServletRequest request) {
		...
		if (e instanceof MethodArgumentNotValidException || e instanceof BindException) {
			// Make the message output more meaningful by providing a map of error codes
			// and messages.
	...
	public static HttpStatus getHttpStatusForException(Exception e) {
		...
		else if (e instanceof AccessDeniedException || e instanceof RestResourceForbiddenException) {
			return HttpStatus.FORBIDDEN;
		}
		else if (e instanceof HttpMessageConversionException || e instanceof MethodArgumentNotValidException
				|| e instanceof MethodArgumentTypeMismatchException || e instanceof MultipartException) {
